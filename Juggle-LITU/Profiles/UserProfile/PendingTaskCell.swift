...
class PendingTaskCell: UICollectionViewCell {
    ...
    fileprivate func specifyBudgetLabelText(_ budget: Int) {
        let attributedText = NSMutableAttributedString(string: "Your Budget (Euros): ", attributes: [.font : UIFont.systemFont(ofSize: 16), .foregroundColor : UIColor.darkGray])
    ...
    fileprivate func specifyLocationLabelText(_ location: String) {
        let attributedText = NSMutableAttributedString(string: "Location: ", attributes: [.font : UIFont.systemFont(ofSize: 14), .foregroundColor : UIColor.darkGray])
        attributedText.append(NSAttributedString(string: location, attributes: [.font : UIFont.systemFont(ofSize: 14), .foregroundColor : UIColor.darkGray]))
